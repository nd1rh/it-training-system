...
<body>
    ...
    <div class="container course-page" style="position: relative; z-index: 1;">
        ...
        <section class="course-table">
            <div class="table-container" style="background: rgba(255, 255, 255, 0.98); backdrop-filter: blur(10px); border-radius: 15px; padding: 20px; 
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex gap-2 justify-content-center" style="white-space: nowrap;">
                                            <a href="<?= base_url('configure/course/edit/' . $row['course_id']) ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit me-1"></i>
                                            Edit</a>
                                            <a href="<?= base_url('configure/course/delete/' . $row['course_id']) ?>" class="btn btn-sm btn-danger" 
                                            onclick="return confirm('Are you sure you want to delete this course?');"><i class="fas fa-trash me-1"></i>Delete</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
