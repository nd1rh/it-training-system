    ...
    <div class="container enrolled-page">
        ...
        <?php else: ?>
            <div class="enrolled-empty-state fade-in-up" style="animation-delay: 0.2s;">
                <div class="enrolled-empty-icon"><i class="fas fa-hourglass-half fa-4x"></i></div>
                <h3 class="enrolled-empty-title">No Courses In Progress</h3>
                <p class="enrolled-empty-desc">Start learning by enrolling in a course!</p>
